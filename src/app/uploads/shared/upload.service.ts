...
export class UploadService {
  ...
  pushUpload(upload: Upload, baseUrl: string, rescallBack) {
    this.basePath = baseUrl;
    const storageRef = firebase.storage().ref();
    var displayDate = new Date().toLocaleString();
    const fileName = this.toTimestamp(displayDate);
  ...
  private toTimestamp(date: string){
